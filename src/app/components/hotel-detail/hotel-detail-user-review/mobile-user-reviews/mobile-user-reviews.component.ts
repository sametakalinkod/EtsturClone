...
@Component({
  selector: 'app-mobile-user-reviews',
  templateUrl: './mobile-user-reviews.component.html',
  styleUrls: ['./mobile-user-reviews.component.scss']
})
export class MobileUserReviewsComponent implements OnInit {
  ...
  constructor(
    private hotelReviewService: HotelReviewsService, public activeModal: NgbActiveModal,
